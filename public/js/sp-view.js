...
function setFontSize(size) {
    ...
    $('.footerText').css({'font-size': parseInt(size)-2 +'px'});/*13*/
    $('.headerPhrase, .headerPhraseAuthor').css({'font-size': parseInt(size)-1 +'px'});/*13*/
    $('body').css({'font-size': parseInt(size) +'px'});/*14*/
    $('.class15').css({'font-size': parseInt(size)+1+'px'});/*15*/
    $('.itemDesc, .sectionTitle p').css({'font-size': parseInt(size) +2+'px'});/*16*/
    $('.class17').css({'font-size': parseInt(size) +3+'px'});/*17*/
    $('.headerNav nav ul li > a, .postContent, .footerNav ul li a').css({'font-size': parseInt(size)+4 +'px'});/*18*/
    $('.class19').css({'font-size': parseInt(size) +5+'px'});/*19*/
    $('.itemTitle').css({'font-size': parseInt(size) +6+'px'});/*20*/
