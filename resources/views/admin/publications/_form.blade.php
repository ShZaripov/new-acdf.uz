<?php echo Form::open(['url' => isset($model->id)?route('publications.update', $model->id):route('publications.store'), 'method' => isset($model->id)?'put':'post', 'files' => true]) ?>
    ...
    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
        ...
        <?php if (isset($model->image) && $model->image != ''): ?>
            <div id="imageBox">
                ...
                <a class="btn btn-danger removeImg" data-url='<?= route('publications.edit',$model->id) ?>'>
