...
<div class="clearfix">
    <a href="{{ route('publications.edit', $model->id) }}" class="btn btn-primary pull-left">Редактировать</a>
</div>
<br>
<!-- /.row -->
...
<hr>
<?php echo Form::open(['route' => ['publications.destroy',$model->id], 'method' => 'delete', 'style' => 'display: inline-block']) ?>
