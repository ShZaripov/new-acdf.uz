...
<div class="clearfix">
    <a href="{{ route('pages.edit', $model->id) }}" class="btn btn-primary pull-left">Редактировать</a>
</div>
<br>
<!-- /.row -->
...
<hr>
<?php if ($model->name != 'about' && $model->name != 'reports' && $model->name != 'practical-information'): ?>
    <?php echo Form::open(['route' => ['pages.destroy',$model->id], 'method' => 'delete', 'style' => 'display: inline-block']) ?>
