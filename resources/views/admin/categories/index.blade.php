...
{{--		</div>--}}
        <h1 class="page-header">Новости категории</h1>
    </div>
</div>
<div class="clearfix">
	<a href="{{ route('categories.create') }}" class="btn btn-primary pull-right">Добавить</a>
</div>
<!-- /.row -->
        	...
        	<?php $i = tableLength($model)['startPage']; foreach ($model as $item): ?>
						<tr>
							...
							<td style="text-align: right;">
								...
								<a href="{{ route('categories.edit', $item->id) }}" class="btn btn-sm btn-primary">
									<i class="glyphicon glyphicon-pencil"></i>
								</a>
								<?php echo Form::open(['route' => ['categories.destroy',$item->id], 'method' => 'delete', 'style' => 'display: inline-block']) ?>
