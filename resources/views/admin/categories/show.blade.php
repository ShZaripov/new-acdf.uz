...
<div class="clearfix">
    <a href="{{ route('categories.edit', $model->id) }}" class="btn btn-primary pull-left">Редактировать</a>
</div>
<br>
<!-- /.row -->
...
<hr>
<?php echo Form::open(['route' => ['categories.destroy', $model->id], 'method' => 'delete', 'style' => 'display: inline-block']) ?>
